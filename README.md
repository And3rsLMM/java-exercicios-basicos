# Java Básico
Este repositório foi criado com o objetivo de conter todas as resoluções dos Desafios de Projeto Básicos da [Formação Java Developer](https://web.dio.me/track/formacao-java-developer) da plataforma de ensino [DIO](www.dio.me).
